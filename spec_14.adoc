 ...
 *job-name*::
 The name of the job.  The name defaults to the first argument of the
 command run by the user, or can be set by the user to an arbitrary
 value.  This field may be used for searching or filtering jobs.
